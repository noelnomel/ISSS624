...
|                       |                       |
|-----------------------|-----------------------|
| Weekday AM Peak Hours | Weekday PM Peak Hours |
| Weekend AM Peak Hours | Weekend PM Peak Hours |
...
## 5.3. Deriving Contiguity Weights and Local Moran's I
...
It is observed from the visualisation that there are more Low-Low clusters than High-High clusters. Most of the Low-Low clusters occur in the Tuas, Lim Chu Kang, Mandai, Marina Bay, and Changi areas. The High-High clusters appear in residential areas such as Woodlands, Choa Chu Kang, Punggol, and Serangoon.
...
tm_shape(lisa_WE_AM_sig) +
  tm_fill("mean") + 
  tm_borders(alpha = 0.4)+
  tm_layout(main.title = "Weekend AM Peak",
            main.title.position = "center",
            main.title.size = 1) +
  tm_scale_bar() +
  tm_grid(alpha = 0.2)
